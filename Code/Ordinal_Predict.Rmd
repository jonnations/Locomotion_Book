...
p1/p2 + plot_annotation(title = "Predicitons for species with known locomotor rankings without phylogenetic information", subtitle = "Top row are arboreal except for scansorial Tupaia\nBottom row are inter-substrate except for terrestrial hedgehog & opossum" ) + plot_layout(guides = "collect") &
  theme(legend.position='bottom')
