...
ggsave(here("Plots", "Predict_Fossil.pdf"), height = 8, width = 10)
...
ggsave(here("Plots", "Predict_Extant.pdf"), height = 10, width = 10)
...
ggsave(here("Plots", "Predict_Extant2.pdf"), height = 6, width = 10)
```
...
ggsave(here("Plots", "Predict_All.pdf"), height = 16, width = 10)
```
