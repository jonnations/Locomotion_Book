...
ord_mod <-  bf(Loc_Ord2 ~ mi(PES2) + mi(MANUS) + mi(PES) + mi(Ppl) + mi(MANUS2) + mi(HPI) + mi(Ipl) + mi(Pipl) + Hl + Rl + Ul + Uol + Fl + OLI + log_Mass + (1|Genus_species) + (1|gr(Taxon_Upham_style,cov = A))) + cumulative()
...
m_form <- ord_mod + PES2_mod + MANUS_mod + PES_mod + Ppl_mod + MANUS2_mod + HPI_mod + Ipl_mod + Pipl_mod + set_rescor(FALSE)
...
#### E. scansoria
```{r  message = FALSE, warning=FALSE, include = FALSE}
ord_mod2 <- bf(Loc_Ord2 ~ mi(PES2) + mi(MANUS) + mi(PES) + mi(Ppl) + mi(MANUS2) + mi(Ipl) + mi(Pipl) + Hl + Rl + Ul + Uol + Fl + OLI + log_Mass + (1|Genus_species) + (1|gr(Taxon_Upham_style,cov = A))) + cumulative()


m2_form <- ord_mod2 + PES2_mod + MANUS_mod + PES_mod + Ppl_mod + MANUS2_mod + Ipl_mod + Pipl_mod + set_rescor(FALSE)
...
#### A. zhoui
```{r  message = FALSE, warning=FALSE, include = FALSE}
ord_mod3 <-  bf(Loc_Ord2 ~  mi(MANUS) +  mi(Ppl) + mi(MANUS2)  + mi(Ipl) + mi(Pipl) + Hl + Rl + Ul + Uol + Fl + OLI + log_Mass + (1|Genus_species) + (1|gr(Taxon_Upham_style,cov = A))) + cumulative()

m3_form <- ord_mod3 +  MANUS_mod  + Ppl_mod + MANUS2_mod + Ipl_mod + Pipl_mod + set_rescor(FALSE)
...
#### R. eurasiaticus
```{r  message = FALSE, warning=FALSE, include = FALSE}
ord_mod4 <- bf(Loc_Ord2 ~ mi(PES2) + mi(MANUS) + mi(PES) + mi(Ppl) + mi(Pipl) + Hl + Rl + Ul + Uol + Fl + OLI + log_Mass + (1|Genus_species) + (1|gr(Taxon_Upham_style,cov = A))) + cumulative()

m4_form <- ord_mod4 + PES2_mod + MANUS_mod + PES_mod + Ppl_mod + Pipl_mod + set_rescor(FALSE)
...
#### I. clarkforkensis
```{r  message = FALSE, warning=FALSE, include = FALSE}
ord_mod5 <-  bf(Loc_Ord2 ~  mi(MANUS) +  mi(Ppl) + mi(MANUS2) + mi(HPI) + mi(Ipl) + Hl + Rl + Ul + Uol + Fl + OLI + log_Mass + (1|Genus_species) + (1|gr(Taxon_Upham_style,cov = A))) + cumulative()

m5_form <- ord_mod5  + MANUS_mod + Ppl_mod + MANUS2_mod + HPI_mod + Ipl_mod + set_rescor(FALSE)
...
m6_form <- ord_mod6 + PES2_mod + MANUS_mod + PES_mod + Ppl_mod + MANUS2_mod + HPI_mod + Ipl_mod + Pipl_mod + set_rescor(FALSE)
...
```{r  message = FALSE, warning=FALSE, include = FALSE}
ord_mod7 <-  bf(Loc_Ord2 ~ mi(PES2) + mi(PES) + mi(HPI) + mi(Pipl) + Hl + Rl + Ul + Uol + Fl + OLI + log_Mass + (1|Genus_species) + (1|gr(Taxon_Upham_style,cov = A))) + cumulative()

m7_form <- ord_mod7 + PES2_mod +  PES_mod  + HPI_mod  + Pipl_mod + set_rescor(FALSE)
...
```{r  message = FALSE, warning=FALSE, include = FALSE}
ord_mod8 <-  bf(Loc_Ord2 ~  mi(MANUS) + mi(Ppl) + mi(MANUS2) + mi(Ipl) + Hl + Rl + Ul + Uol + OLI + log_Mass + (1|Genus_species) + (1|gr(Taxon_Upham_style,cov = A))) + cumulative()
...
```{r  message = FALSE, warning=FALSE, include = FALSE}
ord_mod9 <-  bf(Loc_Ord2 ~  mi(HPI) + Hl + Rl + Ul + Uol + Fl + OLI + log_Mass + (1|Genus_species) + (1|gr(Taxon_Upham_style,cov = A))) + cumulative()

m9_form <- ord_mod9 +  HPI_mod + set_rescor(FALSE)
...
```{r  message = FALSE, warning=FALSE, include = FALSE}
ord_mod10 <-  bf(Loc_Ord2 ~ mi(PES2) + mi(PES) + mi(Pipl) + Fl +  log_Mass + (1|Genus_species) + (1|gr(Taxon_Upham_style,cov = A))) + cumulative()

m10_form <- ord_mod10 + PES2_mod +  PES_mod + Pipl_mod + set_rescor(FALSE)
...
only Ppl and Uol
```{r  message = FALSE, warning=FALSE, include = FALSE}
ord_mod11 <- bf(Loc_Ord2 ~  mi(Ppl) + Uol + log_Mass + (1|Genus_species) + (1|gr(Taxon_Upham_style,cov = A))) + cumulative()

m11_form <- ord_mod11 + Ppl_mod + set_rescor(FALSE)
...
## Save Models
```{r}
list_o2 <- lst(mod1, mod2, mod3, mod4, mod5, mod6, mod7, mod8, mod9, mod10, mod11) %>% write_rds(here("Data","O_lm_mods_multi.Rds"))
```
