...
ggsave(here("Plots", "Bin_Int_Effects.pdf"))
```
...
ggsave(here("Plots", "Bin_Int_All_Effects.pdf"), height = 8, width = 9)
ggsave(here("Plots", "Bin_Int_All_Effects.jpg"), height = 8, width = 9)
```
