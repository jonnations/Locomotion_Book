...
```{r}
var_missing <- c("MANUS2", "Ipl", "PES", "Pppl", "Mtl", "MANUS", "Ppl", "Mcl", "PRTI", "Tpw", "Isl", "Il", "Pel", "Hpw", "HPI", "Mcw", "MRI", "Ppw", "PES2", "Cl", "Pdpw", "Dpw", "Pipw", "Pdpl", "Cal", "Anl", "Atw", "Csw", "Ccw", "Ctl", "Ctw", "Al", "Jl", "Ipw", "Dpl", "Pppw", "Skl", "Mtw", "Fbdw", "Fhd", "Fgh", "Fbmw", "Hhw", "Hhl", "HHRI", "HHW", "Cl", "Fbpw", "Pipl", "PES2", "Ppw", "Mcw", "MRI", "Hpw", "Pel", "Il", "Isl", "Tpw", "Fbl", "HPI", "IRI", "PR", "Hdcw", "DI", "Tdw")
