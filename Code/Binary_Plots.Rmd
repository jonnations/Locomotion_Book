...
sigplotdf %>% 
  ...
  labs(title = "Binary Modeling: Effect Sizes",
       subtitle = "The further the estimates are from 0.5, the stronger the effect of the measurement on climbing.\nMeasurements on the left side increase with decreased climbing (e.g. shorter olecranon) and values on the right decrease with increased climbing ( e.g. longer phalanges)",
       x = "log-odds",
       y = "") +
  facet_wrap(~fct_relevel(dirs,'Values Decrease with Climbing','Values Increase with Climbing'), scales = "free")
