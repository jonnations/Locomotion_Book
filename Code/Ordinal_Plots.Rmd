...
sigplotdf %>% 
  ...
  labs(title = "Ordinal Modeling: Effect Sizes",
       subtitle = "The further the estimates are from 0.5, the stronger the effect of the measurement on climbing.\nMeasurements on the left side increase with increased climbing (e.g. longer phalanges)\nand values on the right decrease with increased climbing (e.g. shorter olecranon)",
       x = "log-odds",
       y = "") +
